...
namespace SingleResponsibilityPrinciple
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ITradeDataProvider adjustedFileProvider = new AdjustTradeDataProvider(urlProvider);
            ...
            TradeProcessor tradeProcessor = new TradeProcessor(adjustedFileProvider, tradeParser, tradeStorage);
